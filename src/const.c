...
*/
	...
	{ "bash", "fast healing" },
	{ 16, 11, 13, 11, 14 },	{ 22, 15, 18, 15, 20 }, SIZE_HUGE
    }
};
 ...
 */
    ...
    {
	"enchant armor",	{ 16, 53, 53, 53 },	{ 1,  1,  2,  2 },
    ...
    {
	"enchant weapon",	{ 17, 53, 53, 53 },     { 1,  1,  2,  2},
 ...
 */
    {
	"acid breath",		{ 37, 53, 53, 53 },     { 1,  1,  2,  2},
    ...
    {
	"fire breath",		{ 39, 53, 53, 53 },     { 1,  1,  2,  2},
    ...
    {
	"frost breath",		{ 31, 53, 53, 53 },     { 1,  1,  2,  2},
    ...
    {
	"gas breath",		{ 40, 53, 53, 53 },     { 1,  1,  2,  2},
    ...
    {
	"lightning breath",	{ 34, 53, 53, 53 },     { 1,  1,  2,  2},
...
/* combat and weapons skills */
    ...
    {
        "enhanced damage",      { 53, 30, 25,  1 },     { 0, 9, 5, 3},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
