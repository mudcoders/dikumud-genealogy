...
#define AFF_PLOADED		 1073741824 /* 18 */
...
DECLARE_SPELL_FUN(		spell_purify			);     /* Kjodo */
...
bool	can_practice_skpell	args( ( CHAR_DATA *ch, int sn ) );
